...
<Layout version="1.6.1">
  ...
  <X>1720</X>
  <Y>14</Y>
  <VerticalWidth>198</VerticalWidth>
  <VerticalHeight>229</VerticalHeight>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\Ian\Workspace\Speedrun\RocketLeagueSpeedrunTools\Speed Jump Rings 1\Rings1AutoSplitter.asl</ScriptPath>
        <Start>True</Start>
        <Reset>True</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="on" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
